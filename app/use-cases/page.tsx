  ...
  return (
    <>
      ...
      <div className={`min-h-screen w-full bg-white text-gray-900 font-sans flex flex-col overflow-hidden relative selection:bg-gray-200`}>
        ...
        {/* --- TOP: TABS --- */}
        <div className={`fixed top-24 w-full z-40 bg-white/80 backdrop-blur-md py-2`}>
        ...
        <div className={`relative z-10 flex-1 w-full flex flex-col pt-45 p-4 overflow-y-auto`}>
