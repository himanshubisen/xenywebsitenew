...
//                 const newCall = {
//                     id: nextId,
//                     caller: ["New Lead A", "New Client B", "Potential Customer C"][Math.floor(Math.random() * 2)],
...
//                                         <div key={call.id} className={`flex items-start justify-between p-3 border rounded-xl transition-all duration-500 ${index === 0 ? 'bg-indigo-50 border-indigo-200 shadow-md' : 'bg-white border-slate-100'}`}>
//                                             <div className="flex-1 min-w-0 mr-3">
//                                                 <div className="flex items-center mb-1">
//                                                     <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full mr-2 ${getTypeColor(call.type)}`}>{call.type}</span>
//                                                     <p className={`font-semibold text-sm truncate ${index === 0 ? 'text-indigo-800' : 'text-slate-800'}`}>{call.caller}</p>
//                                                 </div>
//                                                 <p className="text-xs text-slate-500 truncate">{call.summary}</p>
//                                                 <div className="flex items-center mt-1 gap-2">
//                                                     <span className={`text-[10px] font-medium px-2 py-0.5 rounded-full flex items-center ${getOutcomeColor(call.outcome)}`}>
//                                                         {call.outcome}
//                                                     </span>
...
//                                                 <button title="View Transcript/Recording" className="mt-2 text-indigo-500 hover:text-indigo-700">
//                                                     <Headphones size={14}/>
//                                                 </button>
//                                             </div>
//                                         </div>
...
//                                         {callData.map((call, index) => (
//                                             <tr key={call.id} className={index === 0 ? 'bg-indigo-50 transition-colors' : ''}>
...
//                                                     <span className={`px-2 py-0.5 rounded-full ${getTypeColor(call.type)}`}>{call.type}</span>
//                                                 </td>
...
//                                                 </td>
//                                                 <td className="px-3 py-3 whitespace-nowrap text-xs font-medium">
//                                                     <span className={`px-2 py-0.5 rounded-full ${getOutcomeColor(call.outcome)}`}>{call.outcome}</span>
//                                                 </td>
...
//                                                         <Headphones size={12} className="mr-1"/> Play Recording
//                                                     </button>
//                                                 </td>
//                                             </tr>
//                                         ))}
